...
class BiasEncoding(Layer):
    def __init__(self, sess_max_count, seed=1024, **kwargs):
        ...
        self.seed = seed
        self.sess_bias_embedding = None
        self.seq_bias_embedding = None
        self.item_bias_embedding = None
    ...
    def build(self, input_shape):
        ...
        self.sess_bias_embedding = self.add_weight('sess_bias_embedding', shape=(self.sess_max_count, 1, 1),
                                                   initializer=TruncatedNormal(mean=0.0, stddev=0.0001, seed=self.seed))
