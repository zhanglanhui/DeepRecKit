...
# Build the feature schema referenced by generated training feature-column code.
out = dict()
...
# Export non-label fields for model_input_fn.py.
out_with_neg = {}
for k in list(out.keys()):
    if "label" in k:
        continue
    out_with_neg[k] = copy.deepcopy(out[k])

print(json.dumps(out_with_neg))
